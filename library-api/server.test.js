...
describe('Library API', () => {
  ...
  test('POST /books should add a new book', async () => {
    const newBook = { title: 'New Book', author: 'New Author', year: '2022', genre: 'Science Fiction' };
  ...
  test('PUT /books/:id should update an existing book', async () => {
    const updatedBook = { title: '1984 Updated', author: 'George Orwell', year: '1949', genre: 'Dystopian' };
