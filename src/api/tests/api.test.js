...
describe('API tests', () => {
  ...
  it('should update a book successfully', async () => {
    const updatedBook = { id: 1, title: '1984', author: 'George Orwell', year: '1949', genre: 'Dystopian' };
    const id = 1;
    const responseBook = { id: 1, title: '1984', author: 'George Orwell', year: '1949', genre: 'Dystopian' };
  ...
  it('should handle error while updating a book', async () => {
    ...
    await expect(updateBook(id, { title: 'Updated Book' })).rejects.toThrow('Request failed with status code 500');
  });
