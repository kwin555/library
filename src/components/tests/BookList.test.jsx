...
import { BookContext, BookProvider, bookReducer } from '../../contexts/BookContext';
...
describe('BookList', () => {
  ...
  test('renders a list of books > 0', async () => {
    ...
    const BookProvider2 = ({ children }) => {
        const [books, dispatch] = useReducer(bookReducer, [{ id: 1, title: '1984', author: 'George Orwell', year: '1949', genre: 'Dystopian' }]);
